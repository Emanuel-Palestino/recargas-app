  ...
  return (
    <>
      <View style={styles.content}>
        ...
        <Text style={[styles.value, { color: colors.baseContent }]}>{DISPLAYED_CARRIER[carrier]}</Text>

        <Text style={styles.subtitle}>Tipo de recarga</Text>
        <Text style={[styles.value, { color: colors.baseContent }]}>{DISPLAYED_PRODUCT_TYPE[recargaType]}</Text>

        <Text style={styles.subtitle}>Número celular</Text>
        <Text style={[styles.value, { color: colors.baseContent }]}>{phoneNumber}</Text>

        <Text style={styles.subtitle}>Monto</Text>
        <Text style={[styles.value, { color: colors.baseContent }]}>${amount}</Text>

        {isScheduledRecharge && (
          <>
            <Text style={styles.subtitle}>Fecha Programada</Text>
            <Text style={[styles.value, { color: colors.baseContent }]}>{formatDate(new Date(targetDateTs))}</Text>
          </>
        )}
